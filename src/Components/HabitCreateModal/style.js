...
export const ContainerCategory = styled.div`
    ...
    div.finances{
        color: ${props => props.categoryChose === "finances" ? "#fff" : "#F6AE2D"};
    ...
    div.healthy{
        color: ${props => props.categoryChose === "healthy" ? "#fff" : "#51a957"};
    ...
    div.organization{
        color: ${props => props.categoryChose === "organization" ? "#fff" : "#55CFE0"};
        border: 2px solid var(--blue-light);
        border-top-left-radius: var(--border-radius);
        border-bottom-right-radius: var(--border-radius);
        background: ${props => props.categoryChose === "organization" && "#55CFE0"};

    }
    div.recreation{
        color: ${props => props.categoryChose === "recreation" ? "#fff" : "#eb7eed"};
    ...
    div.cleaning{
        color: ${props => props.categoryChose === "cleaning" ? "#fff" : "#F26419"};
    ...
    div.education{
        color: ${props => props.categoryChose === "education" ? "#fff" : "#b17c6a"};
